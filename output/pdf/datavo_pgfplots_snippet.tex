...
% Verified Table 10 metrics: DataVo (LSM Relaxed) disk 50.700 MB, recovery 0.606 ms, GC 204.000 MB.
\begin{center}
\resizebox{0.86\linewidth}{!}{%
\begin{tikzpicture}
\begin{axis}[
...
\addplot[fill=datavoFreshGreen] coordinates {({DataVo (LSM Relaxed)},50.700)};
