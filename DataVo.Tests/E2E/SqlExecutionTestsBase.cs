...
public abstract class SqlExecutionTestsBase : IDisposable
{
    ...
    private static DataVoConfig CreateIsolatedConfig(DataVoConfig config)
    {
        ...
        return new DataVoConfig
        {
            ...
            SyncDiskWrites = config.SyncDiskWrites,
            IoSchedulerMode = config.IoSchedulerMode,
            WalEnabled = config.WalEnabled,
            WalFilePath = config.WalFilePath,
            WalCheckpointThreshold = config.WalCheckpointThreshold,
            WalCheckpointIntervalMs = config.WalCheckpointIntervalMs,
            TransactionIdStateFilePath = config.TransactionIdStateFilePath,
            CheckpointStateFilePath = config.CheckpointStateFilePath,
            EnableVolcanoExecution = config.EnableVolcanoExecution,
            EnableVolcanoSpillGuardrails = config.EnableVolcanoSpillGuardrails,
            VolcanoSortSpillThresholdRows = config.VolcanoSortSpillThresholdRows,
            VolcanoAggregateSpillThresholdRows = config.VolcanoAggregateSpillThresholdRows,
            VolcanoNestedLoopJoinThresholdRows = config.VolcanoNestedLoopJoinThresholdRows,
            EnableVolcanoExternalSortSpill = config.EnableVolcanoExternalSortSpill,
            VolcanoExternalSortThresholdRows = config.VolcanoExternalSortThresholdRows,
            VolcanoExternalSortRunSizeRows = config.VolcanoExternalSortRunSizeRows,
            VolcanoExternalSortTempDirectory = config.VolcanoExternalSortTempDirectory,
            EnableVolcanoExternalAggregateSpill = config.EnableVolcanoExternalAggregateSpill,
            VolcanoExternalAggregateThresholdRows = config.VolcanoExternalAggregateThresholdRows,
            VolcanoExternalAggregatePartitionCount = config.VolcanoExternalAggregatePartitionCount,
            VolcanoExternalAggregateTempDirectory = config.VolcanoExternalAggregateTempDirectory,
            VolcanoExternalAggregateAdaptivePartitioning = config.VolcanoExternalAggregateAdaptivePartitioning,
            VolcanoExternalAggregateTargetRowsPerPartition = config.VolcanoExternalAggregateTargetRowsPerPartition,
            VolcanoExternalAggregateMaxPartitionCount = config.VolcanoExternalAggregateMaxPartitionCount,
