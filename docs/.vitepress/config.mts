            ...
            items: [
              ...
              { text: 'Constants', link: '/DataVo.Core/Constants/' },
              {
                ...
                items: [
                  ...
                  { text: 'Results', link: '/DataVo.Core/Contracts/Results/' }
                ]
              },
              ...
              { text: 'Logger', link: '/DataVo.Core/Logger/' },
              {
                ...
                items: [
                  ...
                  { text: 'Statement', link: '/DataVo.Core/Models/Statement/' },
                  { text: 'Statement Utils', link: '/DataVo.Core/Models/Statement/Utils/' }
                ]
              },
              {
                text: 'Parser',
                ...
                items: [
                  ...
                  { text: 'Aggregations', link: '/DataVo.Core/Parser/Aggregations/' },
                  ...
                  { text: 'JoinStrategies', link: '/DataVo.Core/Parser/Statements/JoinStrategies/' },
                  {
                    ...
                    collapsed: true,
                    items: [
                      { text: 'Overview', link: '/DataVo.Core/Parser/Statements/Mechanism/' },
              ...
              { text: 'Services', link: '/DataVo.Core/Services/' },
              {
                ...
                items: [
                  ...
                  { text: 'Config', link: '/DataVo.Core/StorageEngine/Config/' },
                  {
                    text: 'Disk',
                    collapsed: true,
                    items: [
                      { text: 'Overview', link: '/DataVo.Core/StorageEngine/Disk/' },
                  ...
                  },
                  {
                    ...
                    collapsed: true,
                    items: [
                      { text: 'Overview', link: '/DataVo.Core/StorageEngine/Memory/' },
                      { text: 'InMemoryStorageEngine', link: '/DataVo.Core/StorageEngine/Memory/InMemoryStorageEngine' }
                    ]
                  },
                  { text: 'Serialization', link: '/DataVo.Core/StorageEngine/Serialization/' }
                ]
              },
