...
| 2 | Relational hardening | 66 | 34 | Added process-wide disk locking for cross-instance writes, index-ordering tests, and mixed int/long numeric key ordering hardening in `IndexKeyEncoder`. Remaining work is broader contention/fuzz coverage and follow-up edge-case passes. |
